...
exports.default = function () {
  ...
  _fs2.default.copyFileSync(_path2.default.resolve(buildDirPath, 'index.html'), _path2.default.resolve(buildDirPath, '200.html'));

  var files = _glob2.default.sync('**/index.html', { cwd: buildDirPath }).map(function (fileName) {
    return ('/' + fileName).slice(0, -11);
  });
  (_options$include = options.include).push.apply(_options$include, _toConsumableArray(files));
